...
internal sealed class GetAllTradeReportsQueryHandler(
    ...
    : IQueryHandler<GetAllTradeReportsQuery, IReadOnlyList<TradeReportResponse>>
{
    public async Task<Result<IReadOnlyList<TradeReportResponse>>> Handle(
        GetAllTradeReportsQuery query,
        CancellationToken cancellationToken)
    {
        ...
        IEnumerable<TradeReportResponse> reports =
            await connection.QueryAsync<TradeReportResponse>(sql);
