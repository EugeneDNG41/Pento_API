...
internal sealed class JoinHouseholdCommandHandler(IGenericRepository<Household> householdRepository, IGenericRepository<User> userRepository, IUnitOfWork unitOfWork) : ICommandHandler<JoinHouseholdCommand>
{
