...
internal sealed class UserSubscriptionCreatedEventHandler(
    INotificationService notificationService,
    IGenericRepository<Subscription> subscriptionRepository,
    IGenericRepository<UserSubscription> userSubscriptionRepository
    ) : DomainEventHandler<UserSubscriptionCreatedDomainEvent>
{
    public override async Task Handle(
        UserSubscriptionCreatedDomainEvent domainEvent,
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new PentoException(nameof(UserSubscriptionCreatedEventHandler), SubscriptionErrors.UserSubscriptionNotFound);
        }
        ...
        {
            throw new PentoException(nameof(UserSubscriptionCreatedEventHandler), SubscriptionErrors.SubscriptionNotFound);
        }
        string title = "Subscription Activated";
        string body = $"Your {subscription.Name} subscription has been activated.";
        ...
        {
            throw new PentoException(nameof(UserSubscriptionCreatedEventHandler), notificationResult.Error);
        }
    }
}
