...
internal sealed class UserSubscriptionPausedEventHandler(
    INotificationService notificationService,
    IGenericRepository<Subscription> subscriptionRepository,
    IGenericRepository<UserSubscription> userSubscriptionRepository
    ) : DomainEventHandler<UserSubscriptionPausedDomainEvent>
{
    public override async Task Handle(
        UserSubscriptionPausedDomainEvent domainEvent,
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new PentoException(nameof(UserSubscriptionPausedEventHandler), SubscriptionErrors.UserSubscriptionNotFound);
        }
        ...
        {
            throw new PentoException(nameof(UserSubscriptionPausedEventHandler), SubscriptionErrors.SubscriptionNotFound);
        }
        string title = "Subscription Paused";
        string body = $"Your {subscription.Name} subscription has been paused.";
        ...
        {
            throw new PentoException(nameof(UserSubscriptionPausedEventHandler), notificationResult.Error);
        }
    }
}
