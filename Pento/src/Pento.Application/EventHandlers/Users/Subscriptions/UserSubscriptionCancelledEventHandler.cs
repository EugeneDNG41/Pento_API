...
internal sealed class UserSubscriptionCancelledEventHandler(
    INotificationService notificationService,
    IGenericRepository<Subscription> subscriptionRepository,
    IGenericRepository<UserSubscription> userSubscriptionRepository
    ) : DomainEventHandler<UserSubscriptionCancelledDomainEvent>
{
    public override async Task Handle(
        UserSubscriptionCancelledDomainEvent domainEvent,
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new PentoException(nameof(UserSubscriptionCancelledEventHandler), SubscriptionErrors.UserSubscriptionNotFound);
        }
        ...
        {
            throw new PentoException(nameof(UserSubscriptionCancelledEventHandler), SubscriptionErrors.SubscriptionNotFound);
        }
        ...
        {
            throw new PentoException(nameof(UserSubscriptionCancelledEventHandler), notificationResult.Error);
        }
    }
}
