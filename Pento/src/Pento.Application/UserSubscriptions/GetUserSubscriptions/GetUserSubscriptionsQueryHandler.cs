...
internal sealed class GetUserSubscriptionsQueryHandler(ISqlConnectionFactory sqlConnectionFactory) : IQueryHandler<GetUserSubscriptionsQuery, IReadOnlyList<UserSubscriptionResponse>>
{
    public async Task<Result<IReadOnlyList<UserSubscriptionResponse>>> Handle(GetUserSubscriptionsQuery query, CancellationToken cancellationToken)
    {
