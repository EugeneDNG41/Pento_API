...
internal sealed class GetCurrentSubscriptionByIdQueryHandler(
    IUserContext userContext,
    ISqlConnectionFactory sqlConnectionFactory) : IQueryHandler<GetCurrentSubscriptionByIdQuery, UserSubscriptionDetailResponse>
{

    public async Task<Result<UserSubscriptionDetailResponse>> Handle(GetCurrentSubscriptionByIdQuery query, CancellationToken cancellationToken)
    {
        ...
        const string sql =
            ...
            WHERE us.id = @UserSubscriptionId AND us.user_id = @UserId AND us.is_deleted IS FALSE;
