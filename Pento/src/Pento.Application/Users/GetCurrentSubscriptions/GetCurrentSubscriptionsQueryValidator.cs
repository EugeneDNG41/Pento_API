...
internal sealed class GetCurrentSubscriptionsQueryValidator : AbstractValidator<GetCurrentSubscriptionsQuery>
{
    public GetCurrentSubscriptionsQueryValidator()
    {
