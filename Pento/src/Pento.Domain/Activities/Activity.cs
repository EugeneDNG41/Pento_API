...
public enum ActivityCode //figure out complex activity like having different types of storage, perhaps create a state class but will require automatic check or use event handler
{
    STORAGE_CREATE,
    FOOD_ITEM_CONSUME,
    HOUSEHOLD_CREATE
