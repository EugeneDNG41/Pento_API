...
public sealed class TradeErrors
{
    ...
    public static readonly Error InvalidRequestState = Error.Conflict("TradeRequest.InvalidState", "Trade request must be pending to continue.");
    ...
    public static readonly Error DuplicateTradeItems = Error.Conflict("Trade.DuplicateItems", "Trade contains duplicate items.");
