...
public record FoodItemReservedForMealPlanConsumed(decimal Quantity, Guid MealPlanId) : FoodItemEvent;
...
public record FoodItemReservedForRecipeConsumed(decimal Quantity, Guid RecipeId) : FoodItemEvent;
...
public record FoodItemReservedForDonationDonated(decimal Quantity, Guid DonationId, Guid RecipientHouseholdId): FoodItemEvent;
...
public record FoodItemCreatedFromSplit(     
     Guid Id,
     Guid SourceFoodItemId,
     Guid FoodRefId,
     Guid CompartmentId,
     decimal Quantity,
     Guid UnitId,
