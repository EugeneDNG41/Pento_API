...
namespace Pento.Infrastructure.Migrations
{
    ...
    [Migration("20251223033456_TradeLocation")]
    partial class TradeLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pento.Domain.Activities.Activity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Code = "COMPARTMENT_CREATE",
                            Description = "Creating a new compartment within a storage location to better organize your food items.",
                        ...
                        new
                        {
                            Code = "FOOD_ITEM_INTAKE",
                            Description = "Adding a new food item to your storage/compartment.",
                            Name = "Intake Food Item"
                        },
                        new
                        {
                            Code = "FOOD_ITEM_DISCARD",
                            Description = "Discarding a food item from your storage/compartment.",
                            Name = "Discard Food Item"
                        },
                        new
                        {
                            Code = "RECIPE_CREATE",
                            Description = "Creating a new recipe to plan your meals and manage ingredients.",
                            Name = "Create Recipe"
                        },
                        new
                        {
                            Code = "RECIPE_COOK",
                            Description = "Cooking a recipe using ingredients from your food items.",
                            Name = "Cook Recipe"
                        },
                        new
                        {
                            Code = "RECIPE_OTHER_COOK",
                            Description = "Having your recipe cooked by another user",
                            Name = "Recipe Cooked By Other"
                        },
                        new
                        {
                            Code = "MEAL_PLAN_CREATE",
                            Description = "Creating a new meal plan to organize your meals for the week.",
                            Name = "Create Meal Plan"
                        },
                        new
                        {
                            Code = "MEAL_PLAN_FULFILLED",
                            Description = "Completing a meal plan by preparing the planned meals.",
                            Name = "Fulfill Meal Plan"
                        },
                        new
                        {
                            Code = "MEAL_PLAN_CANCELLED",
                            Description = "Cancelling a meal plan that is no longer needed.",
                            Name = "Cancel Meal Plan"
                        },
                        new
                        {
                            Code = "GROCERY_LIST_CREATE",
                            Description = "Creating a new grocery list to keep track of items you need to buy.",
                        ...
                        {
                            Code = "HOUSEHOLD_JOIN",
                            Description = "Joining an existing household to collaborate on food management.",
                            Name = "Join Household"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Name = "Trade In Food Item"
                        },
                        new
                        {
                            Code = "FOOD_ITEM_TRADE_AWAY",
                            Description = "Giving a food item to another household through trade.",
                            Name = "Trade Away Food Item"
                        },
                        new
                        {
                            Code = "TRADE_OFFER_CREATE",
                            Description = "Creating a trade offer to exchange food items with other households.",
                            Name = "Create Trade Offer"
                        },
                        new
                        {
                            Code = "TRADE_REQUEST_CREATE",
                            Description = "Creating a trade request for offers from other households.",
                            Name = "Create Trade Request"
                        },
                        new
                        {
                            Code = "TRADE_COMPLETE",
                            Description = "Finalizing a trade between households to exchange food items.",
                            Name = "Complete Trade"
                        });
                });
            ...
            modelBuilder.Entity("Pento.Domain.Features.Feature", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("Pento.Domain.FoodItemReservations.FoodItemReservation", b =>
                {
                    ...
                    b.Property<string>("ReservationFor")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("Pento.Domain.RecipeWishLists.RecipeWishList", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_recipe_wishlists_user_id");
            ...
            modelBuilder.Entity("Pento.Domain.Trades.Reports.TradeReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("TradeSessionId")
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_trade_reports");

                    b.HasIndex("ReporterUserId")
                        .HasDatabaseName("ix_trade_reports_reporter_user_id");
            ...
            modelBuilder.Entity("Pento.Domain.Trades.TradeReportMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("TradeReportId")
                        .HasColumnType("uuid")
                        .HasColumnName("trade_report_id");

                    b.HasKey("Id")
                        .HasName("pk_trade_report_medias");

                    b.HasIndex("TradeReportId")
                        .HasDatabaseName("ix_trade_report_medias_trade_report_id");

                    b.ToTable("trade_report_medias", (string)null);
                });
            ...
            modelBuilder.Entity("Pento.Domain.Trades.TradeSession", b =>
                {
                    ...
                    b.Property<Guid>("TradeRequestId")
                        .HasColumnType("uuid")
                        .HasColumnName("trade_request_id");
            ...
            modelBuilder.Entity("Pento.Domain.Trades.TradeItemOffer", b =>
                {
                    ...
                    b.HasIndex("OfferId")
                        .HasDatabaseName("ix_trade_items_offer_id");
            ...
            modelBuilder.Entity("Pento.Domain.Trades.TradeItemRequest", b =>
                {
                    b.HasBaseType("Pento.Domain.Trades.TradeItem");
                    ...
                    b.HasIndex("RequestId")
                        .HasDatabaseName("ix_trade_items_request_id");
            ...
            modelBuilder.Entity("Pento.Domain.RecipeWishLists.RecipeWishList", b =>
                {
                    ...
                    b.HasOne("Pento.Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_recipe_wishlists_user_user_id");
                });
            ...
            modelBuilder.Entity("Pento.Domain.Recipes.Recipe", b =>
                {
                    b.HasOne("Pento.Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_recipes_user_created_by");
            ...
            modelBuilder.Entity("Pento.Domain.Subscriptions.SubscriptionFeature", b =>
                {
                    b.HasOne("Pento.Domain.Features.Feature", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pento.Domain.Trades.Reports.TradeReport", b =>
                {
                    b.HasOne("Pento.Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_trade_reports_user_reporter_user_id");
                });
            ...
            modelBuilder.Entity("Pento.Domain.Trades.TradeReportMedia", b =>
                {
                    b.HasOne("Pento.Domain.Trades.Reports.TradeReport", null)
                        .WithMany()
                        .HasForeignKey("TradeReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trade_report_medias_trade_reports_trade_report_id");
                });
            ...
            modelBuilder.Entity("Pento.Domain.Trades.TradeSession", b =>
                {
                    ...
                    b.HasOne("Pento.Domain.Trades.TradeOffer", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trade_sessions_trade_offers_trade_offer_id");

                    b.HasOne("Pento.Domain.Trades.TradeRequest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pento.Domain.Trades.TradeItemOffer", b =>
                {
                    b.HasOne("Pento.Domain.Trades.TradeOffer", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trade_items_trade_offer_offer_id");
                });
