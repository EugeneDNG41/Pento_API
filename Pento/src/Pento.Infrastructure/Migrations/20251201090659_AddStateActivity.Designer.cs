...
namespace Pento.Infrastructure.Migrations
{
    ...
    [Migration("20251201090659_AddStateActivity")]
    partial class AddStateActivity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pento.Domain.Activities.Activity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Code = "STORAGE_TYPE_PANTRY",
                            Description = "Number of pantry storages.",
                            Name = "Storage Type Pantry",
                            Type = "State"
                        },
                        new
                        {
                            Code = "STORAGE_TYPE_REFRIGERATOR",
                            Description = "Number of refrigerator storages.",
                            Name = "Storage Type Refrigerator",
                            Type = "State"
                        },
                        new
                        {
                            Code = "STORAGE_TYPE_FREEZER",
                            Description = "Number of freezer storages.",
                            Name = "Storage Type Freezer",
                            Type = "State"
                        },
                        new
                        {
                            Code = "COMPARTMENT_QUANTITY",
                            Description = "Number of compartments.",
                            Name = "Compartment Quantity",
                            Type = "State"
                        },
                        new
                        {
                            Code = "FOOD_ITEM_QUANTITY",
