    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                ...
                { "compartments:update", "Rename/reorder compartments and edit their attributes.", "UpdateAsync Compartments" },
                ...
                { "fooditems:update", "Edit item details and adjust quantities (consume/waste/donate).", "UpdateAsync Food Items" },
                ...
                { "giveaways:update", "Edit giveaway posts you created.", "UpdateAsync Giveaways" },
                ...
                { "groceries:update", "Edit grocery lists and list items.", "UpdateAsync Groceries" },
                { "household:read", "View the current household’s profile, settings, and membership. Read-only.", "View Household" },
                { "household:update", "UpdateAsync household name and invite code.", "Manage Household" },
                ...
                { "mealplans:update", "Modify meal plans.", "UpdateAsync Meal Plans" },
                { "members:delete", "RemoveAsync/kick members from the household and revoke their access.", "RemoveAsync Members" },
                ...
                { "recipes:update", "edit your own recipes.", "UpdateAsync Recipes" },
                ...
                { "storages:update", "Rename storages and modify their attributes.", "UpdateAsync Storages" },
